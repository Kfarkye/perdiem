...
export type ConstructionSchedule = "4x10" | "5x8" | "5x10" | "6x10" | "7x12" | "custom";
...
export function scheduleToHours(schedule: ConstructionSchedule, custom?: number): number {
    switch (schedule) {
        case "4x10": return 40;
        case "5x8": return 40;
        case "5x10": return 50;
...
export function scheduleLabel(schedule: ConstructionSchedule): string {
    switch (schedule) {
        case "4x10": return "4×10 (40hr)";
        case "5x8": return "5×8 (40hr)";
        case "5x10": return "5×10 (50hr)";
        case "6x10": return "6×10 (60hr)";
        case "7x12": return "7×12 (84hr)";
 ...
 */
export function computeConstructionPay(input: ConstructionInput): ConstructionBreakdown {
